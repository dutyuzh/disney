  ...
  useEffect(() => {
    const fetchCharacterDetails = async () => {
      ...
      try {
        ...
        const res = await disneyApiClient.get<ApiResponse>(
        ...
        setError(
          'We couldn’t fetch their details, but don’t worry, they’re probably off on an adventure! Try again later, and we’ll bring them back to you.'
        )
        setLoading(false)
      }
    }
